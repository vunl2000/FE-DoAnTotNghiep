...
const ModalConfirmPasswordChange = (props: Props) => {
  ...
  const [visibleIconEmail, setVisibleIconEmail] =
  ...
  function userConfirmEmail(email: any) {
    ...
    var config = {
      method: 'post',
      url: 'http://18.141.199.110:3000/account-user/gmail-authentication-user',
      headers: {
  ...
  function VerifyOTP(emailOTP: string | any, numberOTP: string | any) {
    ...
    var config = {
      method: 'post',
      url: 'http://18.141.199.110:3000/account-user/verify-otp-submit',
      headers: {
        'Content-Type': 'application/json',
      },
      data: data,
      ...
      <View
        ...
        <View
          ...
          <Text
            ...
            Xác nhận email của bạn và gửi OTP đặt lại
          </Text>
          <Input
            value={email}
